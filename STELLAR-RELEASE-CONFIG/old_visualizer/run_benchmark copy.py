...
from old_visualizer.visualizer_all import write2text
...
cwd = os.getcwd()
BASE_STATS = os.path.join(cwd, "envstats/vbar-agentFirst.pkl")
...
if usr_policy == 'y':
    ...
    fresh_model = PPO.load(policy_dir, env=bench_env, print_system_info=True, policy_kwargs=policy_args, _init_setup_model=False, force_reset=True, device='cpu')
